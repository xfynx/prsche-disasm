...
Обновлено 2026-09-23. **008-race-loop завершена** (тег `iteration-008`); подготовка к `009-game-shell`.
...
## Активная итерация: подготовка к 009-game-shell
- Снимок: будет создан из `iteration-008`.
- Рабочий план: [docs/next-iteration.md](docs/next-iteration.md).
